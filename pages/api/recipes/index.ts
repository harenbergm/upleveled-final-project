...
export default async function handler(
  ...
  const difficultySelected = recipe.difficultySelected;
  const ingredientsSelected = recipeIngredients.ingredientsSelected;
  ...
  const getRecipeId = getRecipeId(iD);

  const newRecipeIngredients =
    createRecipeIngredientsByReceipeIdAndIngredientId(getRecipeId, iD);
